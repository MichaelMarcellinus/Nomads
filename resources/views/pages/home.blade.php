                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                      <div class="testimonial-content">
                        ...
                        <h3 class="mb-4">Deddy</h3>
                        <p class="testimonial">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatem laboriosam officia, odio dolorum fuga autem.</p>
                      </div>
                      <hr />
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                      <div class="testimonial-content">
                        ...
                        <h3 class="mb-4">Endang</h3>
                        <p class="testimonial">
                          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque ipsa, voluptatibus accusantium molestiae delectus laborum.
                        </p>
                      </div>
                      <hr />
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                      <div class="testimonial-content">
                        ...
                        <h3 class="mb-4">Dwi</h3>
                        <p class="testimonial">
                          Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia commodi eos obcaecati cum harum. Distinctio, ipsum totam.
                        </p>
                      </div>
                      <hr />
